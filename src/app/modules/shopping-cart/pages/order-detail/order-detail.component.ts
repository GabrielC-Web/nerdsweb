...
import { OrderDetailModel, OrderStatus, ProductVariantModel } from '../../models/shopping-cart.model';
import { ActivatedRoute } from '@angular/router';
import { Location } from '@angular/common';
import { ShoppingCartService } from '../../services/shopping-cart.service';
import { typeProducts } from 'src/app/modules/dashboard/models/products.models';
import { NerdsWebIsotipo, glassesImg, glassesWinkImg } from 'src/assets/images/images-routes';

@Component({
  selector: 'pag-order-detail',
  templateUrl: './order-detail.component.html',
  styleUrls: ['./order-detail.component.scss']
})
export class OrderDetailLayoutComponent implements OnInit {

  /**
   * Imagenes
   */
  glassesImg: string = glassesImg;
  glassesWinkImg: string = glassesWinkImg;
  ...
  getOrderDetail(idOrder: string) {
    ...
    this.shoppingCartService.getOrderDetail(idOrder).subscribe({
      next: (response: any) => {
